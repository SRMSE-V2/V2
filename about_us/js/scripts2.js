$(document).ready(function(){
    ...
    //-----------------------------Vertical 1--------------------------
              ...
              var v1 = '[{"name":"Shashank Prasad","img":"images/v1/shashank_pasad.jpg","desc":"Senior Vertical Head"},{"name":"Ketul Patani","img":"images/v1/ketul.jpg","desc":"Vertical Head"},{"name":"Akshith Gunasekaran","img":"images/v1/akshith.jpg","desc":""},{"name":"Shekhar Singh","img":"images/v1/shekhar.jpg","desc":""},{"name":"Arnab Kundu","img":"images/v1/arnab.jpg","desc":""},{"name":"Sonam Sherpa","img":"images/v1/sonam.jpg","desc":""}]';
              var lang1 = '';
    ...
    //----------------------------Vertical 2-----------------------------  
     $('#b2').click(function(){
              ...
              var v2 = '[{"name":"Anoop Niranjan","img":"images/v2/anoop2.jpg","desc":"Senior Vertical Head"},{"name":"Ankit Agarwal","img":"images/v2/ankit.jpg","desc":"Web Design"},{"name":"Sandeep Agarwal","img":"images/v2/sandeep.jpg","desc":"Web Development"}]';
              var lang2 = '';
    ...
    $('#b3').click(function(){
        ...
        var v3 = '[{"name":"Guru Prakash","img":"images/v3/guru.jpg","desc":"Founder"}]';
              var lang3 = '';
