...
function main(files) {
	for (i = 0; i < files.length; i++) {
		fs.readFile("/home/srmse/Desktop/IQT/NewCrawler1/crawlNEW/" + files[i], function(err, data) {
...
var fs=require('fs');
fs.writeFile("/home/srmse/Desktop/IQT/NewCrawler1/monogocache/monogocache.txt"+parseInt(Math.random()*10000), process.final_inlinks.join("\n"), function(err) {
...
function moveFile(fn) {
	...
	fs.unlink("/home/srmse/Desktop/IQT/NewCrawler1/crawlNEW/" + fn, function(err) {
console.log(err);
		if (!err) {
			console.log("moved");
			global.clean();
