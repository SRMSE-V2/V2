(function() {
    ...
    var BAT = "";
    var RECENT = "";
    var CRICKET_STATS = $("<div class=\"module\" id=\"cricket_players\" style=\"border:0px;color:white;\">                <!-- Player info -->                  <div class=\"row player_info\">                        <div class=\"col-xs-12 col-sm-3 col-md-3 col-lg-3\" style=\"margin-top:10px;\">                            <img class=\"cric_img media-object img-responsive\"  alt=\"image\">                        </div>                        <div class=\"pl_info col-xs-12 col-sm-9 col-md-9 col-lg-9\" style=\"margin-top:10px\">                                                                             </div>                  </div>                <!-- /Player info -->                              <div class=\"row cricket_players_details\" style=\"margin:0px\">                  <div id=\"pl_other_info\" class=\"col-xs-12 alpha-blur\" style=\"border:0px solid;margin-bottom:5px>                                                                                                            </div>                                    </div>            <div class=\"row\">  <div class=\"col-lg-6\">                   </div>  <div class=\"col-lg-6\"> <button type=\"button\" class=\"btn btn-us alpha-blur cricket_players_button\" style=\"float:right;font-size:20px;color:white;border:0px\" aria-label=\"Left Align\">                    <span class=\"glyphicon glyphicon-stats\" aria-hidden=\"true\"></span> Click for more information                </button>           </div>    </div>  </div>");
