...
$("#ballimg").attr("src","/ver1/images/ball.png");
                                ...
                                var team2 = window.val["General"].split(" v ")[1].replace(window.val["General"].split(" v ")[1].trim().match(patt)[0], "");
