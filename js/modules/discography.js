...
if(el["release_date"]==="None"){
	...
	var temp=$("<li><div><a style=\"text-decoration:none;\" href="+el["album_link"]+" target=\"_blank\"><span class=\"no_cover\">"+el["album_name"][0]+"</span></div><div class=\"album_info\"><div>"+el["album_name"]+"</div><div>"+date+"</div></div></a></li>");
