if($("#site").length===0){
var site=$("<div  class=\"row module\"><div class=\"col-lg-12\"><div class=\"col-lg-4 col-lg-push-8\"><a href=\"http://"+window.val["main-ans"]["website"]+"\"><img id=\"site_img\" src=\"download.jpg\"alt=\"logo\" style=\"display:block;margin-left:auto;margin-right:auto;padding-top:30px;\"></a></div><div class=\"col-lg-8 col-lg-pull-4\" style=\"\"><div id=\"site_title\" class=\"page-header\"></h1></div></div></div><div class=\"row\"><div class=\"col-lg-12\"><p id=\"site_details\" style=\"padding-left:20px;\"class=\"wrap\"></p></div></div></div>");
$("#centre_parent").prepend(site);
