...
$(".active").removeClass("active");$(t).parent().addClass("active");
    ...
    $("#smart_answer").addClass("hide");
        ...
        CRICKET_STATS.find(".cricket_players_details").append("<ul class=\"nav nav-tabs\"><li role=\"presentation\" class=\"active\"><a class=\"cricket_stats\" href=\"#\">Career Statistics</a></li><li role=\"presentation\"><a href=\"#\" class=\"cricket_bowl\">Bowling</a></li><li role=\"presentation\"><a class=\"cricket_bat\" href=\"#\">Batting</a></li></ul><div style=\"padding:10px;\" class=\"row cricket_cont\"></div>");
