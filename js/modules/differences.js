...
var differences=$('<div class="well alpha-blur" style="border:0px;color:white;text-align:left" id="differences"><h3 style="margin-top:0px;">Difference between <span id="dif_title1"></span> and <span id="dif_title2"></span></h3><h6 id="dif_text"></h6><h5><a href="#" style="color:#7f8c8d !important;" id="dif_link"></a></h5></div>');
...
$("#dif_text").append("<span><a style=\"padding-left:5px; color: #7f8c8d !important;\" target=\"_blank\" href=\""+window.val["link"]+"\" >...</a></span>");
