if($("#meaning").length===0){
var meaning=$("<div id =\"meaning\"class=\"module\" style=\"margin-bottom:30px;border:0px;color:white;text-align:left;\" id=\"dictionary\"> <div><h1 id=\"dict_keyword\" style=\"margin:0px;display:inline;\"></h1></div><div id=\"dict_details\" style=\"padding-top:0px\"></div> <div style=\"padding-top:0px;display:block;height:28px;\"><button class=\"btn glyphicon glyphicon-th-list\" id=\"dict_button\" style=\"border:0px;background-color:transparent;\">&nbsp;Verbs, synonyms etc</button><a href=\"http://dictionary.reference.com/browse/"+window.val["keyword"]+"\" target=\"_blank\" class=\"btn dic\" style=\"float:right;border:0px;background-color:transparent;line-height:16px;font-size:16px;\"><img src=\"http://www.google.com/s2/favicons?domain=http://dictionary.com\" height=\"16\" style=\"padding-right:5px;\"/>Dictionary.com</a> </div></div>");
$.getScript("/js/modules/voice.js");
$("#centre_parent").prepend(meaning);
once=1;
