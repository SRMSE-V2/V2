...
$("#light_theme").remove();
  ...
  function img_fallback(){
    var img = document.getElementById("srm-logo");
     var img1 = document.getElementById("nixi-logo");
     var img2 = document.getElementById("srmse-logo");
      if (window.color === "dark" || window.color==="light") {
                img2.setAttribute("src", "http://srmse-v2.github.io/V2/images/"+window.color+"/srmselogo.png");
                img1.setAttribute("src", "http://srmse-v2.github.io/V2/images/"+window.color+"/nixi.png");
                img.setAttribute("src", "http://srmse-v2.github.io/V2/images/"+window.color+"/srm.png");
            }
          
  }     
  $("img").on("error",img_fallback);
