...
(function() {
    ...
    $(document).ready(function() {
        ...
        var modal=$('<div id="modalSwitchTheme" class="hide" style="width:100%;height:100%;position:absolute;left:0px;top:0px;z-index:1000;background-color:rgba(51, 51, 51, 0.74);"></div>');
        $('body').append(modal);
        ...
        var dispBtns = function() {
            ...
            $("#light").on('click', function() {
                ...
                $('#modalSwitchTheme').removeClass('hide');
                stylesheet.load(function(){
                	$("#dark_theme").remove();
                	$('#modalSwitchTheme').addClass('hide');
                });
            });
