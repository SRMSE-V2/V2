...
(function() {
    ...
    $(document).ready(function() {
        ...
        var modal=$('<div id="modalSwitchTheme" class="hide" style="width:100%;height:100%;position:absolute;left:0px;top:0px;z-index:1000;background-color:'+MODAL_BACK+';"></div>');
        $('body').append(modal);
        }
