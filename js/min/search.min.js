...
$.each(e,function(e,t){t.indexOf(J)<0&&t.indexOf("autocomplete")<0&&localStorage.removeItem(t)})}}function i(e,t){elChild=document.createElement("style"),elChild.setAttribute("id",t),elChild.innerHTML=e,document.getElementsByTagName("head")[0].appendChild(elChild)}function a(){$("#modalSwitchTheme").remove(),"dark"===window.color?G="rgba(241, 241, 241, 0.74)":"light"===window.color&&(G="rgba(51, 51, 51, 0.74)")
...
e.hide().appendTo("body").fadeIn(1e3)}function o(e){window.location="/cgi-bin/s.py?q="+encodeURIComponent(e)}function n(e){var t=e.children()
$.each(t,function(e,t){try{$(t).attr("class").indexOf("infobox")<0&&$(t).remove()}catch(i){$(t).remove()}}),$.each(e.contents(),function(e,t){try{"TABLE"!==$(t).prop("tagName")&&$(t).remove()}catch(i){$(t).remove()}})}function r(){var e=$(V.replace(/<img (.*?)\/>/g,"").replace(/\?+/g,""))
...
t.error?O=!1:(q=t.ids,v(t.results,$("#search_results"),!1,!0,!1),O=!0)})}function v(e,t,i,a,o,n){if(e[0]){i?V=e[0].infobox:(O=!0,E+=10,j+=10)
var r=$()
...
m.find(".ambox").remove(),m.find(".error").remove(),m.find(".mw-ext-cite-error").remove(),u.html($("<div/>").append(m).html())}else if(n){u=$("<div></div>"),u.addClass("search_info")
...
window.SA={}
var M=!1,L=!1,z=!1,F=[],V="",G="",R="",J="SECRET_KEY"
...
a.height=e.height,a.width=e.width,o.drawImage(i,0,0,e.width,e.height),dataURL=a.toDataURL("image/png"),console.log(dataURL),e.setAttribute("src",dataURL),localStorage.setItem(t+"#image",dataURL),a=null}}(t,e)}},t()
var U=function(){L=!0,e("/js/min/"+R+".min.js","js")},H=function(){z=!0,e("/js/min/"+R+".min.js","js")},B={general:U,sports:H,stock:H,train:H,weather:U,movie:U,exam:H,location:H,minerals:H,differences:U,wiki:U,dict:U,theatre:U,highway:H,"cricket-players":U,ministers:H,bank:H,highcourt:H,discography:U,flight:H,tennis:U}
console.log(B)
...
console.log(R),basket.require({url:"http://srmse-v2.github.io/V2/css/light/search"+J+".min.css",execute:!1,expire:168}).then(function(e){var a=e[0].data
