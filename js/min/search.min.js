...
$.each(t,function(e,t){try{$(t).attr("class").indexOf("infobox")<0&&$(t).remove()}catch(i){$(t).remove()}}),$.each(e.contents(),function(e,t){try{"TABLE"!==$(t).prop("tagName")&&$(t).remove()}catch(i){$(t).remove()}})}function r(){var e=$(G.replace(/<img (.*?)\/>/g,"").replace(/\?+/g,""))
...
t.error?O=!1:(q=t.ids,v(t.results,$("#search_results"),!1,!0,!1),O=!0)})}function v(e,t,i,a,o,n){if(e[0]){i?G=e[0].infobox:(O=!0,E+=10,j+=10)
var r=$()
...
console.log(n),e.setAttribute("src",n),localStorage.setItem(t+"#image#"+e.width+"#key#"+H,n),a=null}}(t,e)}else t.setAttribute("src",e)},t()
