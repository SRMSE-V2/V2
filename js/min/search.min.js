...
t.error?O=!1:(j=t.ids,v(t.results,$("#search_results"),!1,!0,!1),O=!0)})}function v(e,t,i,a,o,r){if(e[0]){i?G=e[0].infobox:(O=!0,E+=10,I+=10)
var n=$()
...
i||o||(O=!1,t.append(s))}}function w(e,t){if(E<j.length)j&&O&&$.ajax({url:"/cgi-bin/queryret/getMore.py",dataType:"text",type:"GET",async:!0,data:{q:""+j.slice(E,I).toString(),f:S,authenticity_token:$("meta[name='csrf-token']").attr("content")},error:function(){$("#search_results").append(i),O=!1}}).done(function(e){var t=JSON.parse(e)
t.error?O=!1:v(t.results,$("#search_results"),!1,!0,!1)})
else{var i=c()
$("#search_results").append(i),O=!1}}function y(){$(window).scrollTop()+$(window).height()>$(document).height()-100&&($(window).unbind("scroll"),O&&($("#search_results").append(P),$("#loading").width($("#search_results").width()),setTimeout(function(){w(E,I,!0)},1e3)))}function _(){$.ajax({async:!0,url:"/cgi-bin/queryret/getIds.py",dataType:"text",type:"GET",data:{q:$("#search").val().trim().toLowerCase(),f:2,authenticity_token:$("meta[name='csrf-token']").attr("content")},error:function(){}}).done(function(e){try{var t=JSON.parse(e)
...
S=1
var i=Y[t],a=V[i]
return j=a,E=0,I=10,$.ajax({async:!0,url:"/cgi-bin/queryret/getMore.py",dataType:"text",type:"GET",data:{q:j.slice(E,I).toString(),f:S,authenticity_token:$("meta[name='csrf-token']").attr("content")},error:function(){var e=c()
$("#search_results").append(e)}}).done(function(e){var t=JSON.parse(e)
if(t.error){var i=c()
$("#search_results").append(i)}else v(t.results,$("#search_results"),!1,!1,!1)}),!1}$.ajaxSetup({cache:!0})
var S=1,A=$("#search").val().trim(),E=0,I=10,j=[],q=0,N=4,O=!0,D=[]
window.SA={}
var M=!1,z=!1,F=!1,V=[],G="",L="",J="",H="SECRET_KEY"
window.cacheImage=function(e,t){var i=document.createElement("canvas")
if("undefined"!=typeof Storage&&i.getContext){var a=localStorage.getItem(e+"#image#"+t.width+"#key#"+H)
a?t.setAttribute("src",a):!function(e,t){var i=new Image
