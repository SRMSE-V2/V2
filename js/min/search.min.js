...
t.error?T=!1:(j=t.ids,m(t.results,$("#search_results"),!1,!0),T=!0)})}function m(e,t,i,a){if(e[0]){i?N=e[0].infobox:(T=!0,b+=10,x+=10)
var n=$()
...
i?t.append(r):T=!1}}function u(e,t){if(b<j.length)j&&T&&$.ajax({url:"/cgi-bin/queryret/getMore.py",dataType:"text",type:"GET",async:!0,data:{q:""+j.slice(b,x).toString(),f:"1",authenticity_token:$("meta[name='csrf-token']").attr("content")},error:function(){$("#search_results").append(i),T=!1}}).done(function(e){var t=JSON.parse(e)
t.error?T=!1:m(t.results,$("#search_results"),!1,!0)})
else{var i=s()
...
t.error||m(t.results,$("#wikiMain"),!0,!0)}catch(i){}})}function w(e){$.ajax({async:e,url:"/cgi-bin/queryret/getIds.py",dataType:"text",type:"GET",data:{q:$("#search").val().trim().toLowerCase(),f:3,authenticity_token:$("meta[name='csrf-token']").attr("content")},error:function(){}}).done(function(e){try{var t=JSON.parse(e)
t.error||m(t.results,$("#news"),!1,!0)}catch(i){}})}function v(){""!==$("#search").val().trim()&&$.ajax({async:!0,url:"/cgi-bin/new2/smart/getSmartAns.py",dataType:"text",type:"GET",data:{q:$("#search").val().trim().toLowerCase(),authenticity_token:$("meta[name='csrf-token']").attr("content")},error:function(){$("#smart_answer").removeClass("show"),$("#smart_col").addClass("hide")}}).done(function(e){try{var t=JSON.parse(e.replace(/\n/g,"").trim())
...
if(t.error){var i=s()
$("#search_results").append(i)}else m(t.results,$("#search_results"),!1,!1)}),!1}$.ajaxSetup({cache:!0}),$.getScript("/js/min/jquery-ui.min.js",function(){$.getScript("/js/min/auto.min.js")})
