...
$.each(t,function(e,t){try{$(t).attr("class").indexOf("infobox")<0&&$(t).remove()}catch(i){$(t).remove()}}),$.each(e.contents(),function(e,t){try{"TABLE"!==$(t).prop("tagName")&&$(t).remove()}catch(i){$(t).remove()}})}function n(){var e=$(V.replace(/<img (.*?)\/>/g,"").replace(/\?+/g,""))
...
t.error?O=!1:(q=t.ids,v(t.results,$("#search_results"),!1,!0,!1),O=!0)})}function v(e,t,i,a,o,r){if(e[0]){i?V=e[0].infobox:(O=!0,E+=10,j+=10)
var n=$()
...
a.height=e.height,a.width=e.width,o.drawImage(i,0,0,e.width,e.height),dataURL=a.toDataURL("image/png"),console.log(dataURL),e.setAttribute("src",dataURL),localStorage.setItem(t+"#image",dataURL),a=null}}(t,e)}else t.setAttribute("src",e)},t()
