...
e.extend(a,{_initSource:function(){this.options.html&&e.isArray(this.options.source)?this.source=function(e,a){a(t(this.options.source,e.term))}:n.call(this)},_renderItem:function(t,a){return e("<li></li>").data("item.autocomplete",a).append(e("<a></a>")[this.options.html?"html":"text"](a.label)).appendTo(t)}})}(jQuery),$("#search").autocomplete({source:function(e,a){function n(){$.ajax({url:"/cgi-bin/ac/getWords.py",dataType:"text",data:{q:e.term},success:function(n){t(n,e.term),a(JSON.parse(n))}})}if("undefined"!=typeof Storage){var i=localStorage.getItem("autocomplete#query#"+e.term)
